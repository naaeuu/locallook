            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" required
                            class="search-bar-input py-3">
                    </div>

                    <div>
                        <label for="price" class="block text-sm font-medium text-gray-700">Harga (Rp)</label>
                        <input type="number" name="price" id="price" value="{{ old('price') }}" required
                            class="search-bar-input py-3" placeholder="Contoh: 350000">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="categories" id="categories" value="{{ old('categories') }}"
                            class="search-bar-input py-3" placeholder="Contoh: pria atasan outer (pisahkan spasi)">
                    </div>

                    <div>
                        <label for="is_featured" class="flex items-center gap-2 text-sm font-medium text-gray-700">
                            <input type="checkbox" name="is_featured" id="is_featured" value="1"
                                class="rounded text-maroon focus:ring-maroon" {{ old('is_featured') ? 'checked' : '' }}>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="description" id="description" rows="6" class="search-bar-input py-3">{{ old('description') }}</textarea>
                    </div>
